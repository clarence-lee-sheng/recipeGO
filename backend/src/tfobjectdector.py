...
def display_image(image):
    ...
    image_pil.show()
    image_pil.save("../images/test_with_tensorflow_objectdetector2.jpg")
...
image_url = "https://raw.githubusercontent.com/forresthu/visionai/master/imgs/67569905.jpg"
...
def run_detector(detector, path):
    ...
    image_with_boxes = draw_boxes(
        ...
        result["detection_class_entities"], result["detection_scores"], max_boxes=90)
